...
export default function HappynessBar(props) {
  ...
  return ( <
    ...
    <
    div className = {
      `${textAnimation(2200)} happyText`
    } > amazing < /div> <
    div className = {
      `${textAnimation(1800)} happyText`
    } >
    feeling lucky <
    /div> <
    div className = {
      `${textAnimation(1300)} happyText`
    } > great < /div> <
    div className = {
      `${textAnimation(800)} happyText`
    } > fine < /div> <
    div className = {
      `${textAnimation(400)} happyText`
    } > ok < /div> <
    /div> <
    /div> <
    /div> <
    h3 > FOO BAR HAS HAPPILLY SERVED : {
      props.amountSold
    }
    CL < /h3> <
    /div>
